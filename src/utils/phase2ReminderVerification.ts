...
import type { ReminderEvent } from "../engine/reminderEngine.js";
...
function assertEqual(label: string, actual: string | boolean, expected: string | boolean) {
  if (actual !== expected) {
    throw new Error(`${label}: expected ${String(expected)}, received ${String(actual)}`);
  }
}

function summarizeActions(reminder: ReminderEvent, people: Person[], relationships: Relationship[], today: Date) {
  ...
  const relationalRecipients =
    context?.kind === "childThroughRelationship" || context?.kind === "childBirthday" ? context.recipients : [];
  ...
  if (relationalRecipients.length > 0 && context) {
    ...
    return {
      ...
      giftEligible: false,
      notificationTitle:
        buildReminderNotification(reminder, today, undefined, people, relationships)?.title ?? "",
      notificationBody:
        buildReminderNotification(reminder, today, undefined, people, relationships)?.body ?? "",
    };
  }
...
const scenarios: Scenario[] = [
  {
    ...
    expect: {
      reminderLabel: "Ryan turns 36 today",
      reminderRecipient: "Ryan",
      textActionTarget: "Ryan",
      ecardTarget: "Ryan",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Ryan turns 36 today",
      notificationBody,
    },
  },
  {
  ...
  },
  {
    ...
    expect: {
      reminderLabel: "Mom turns 66 today",
      reminderRecipient: "Mom",
      textActionTarget: "Mom",
      ecardTarget: "Mom",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Mom turns 66 today",
      notificationBody,
    },
  },
  {
    ...
    expect: {
      reminderLabel: "Ben turns 38 today",
      reminderRecipient: "Ben",
      textActionTarget: "Ben",
      ecardTarget: "Ben",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Ben turns 38 today",
      notificationBody,
    },
  },
  {
    ...
    expect: {
      reminderLabel: "Ben & J’s anniversary today",
      reminderRecipient: "J",
      textActionTarget: "J",
      ecardTarget: "J",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Ben & J’s anniversary today",
      notificationBody,
    },
  },
  {
    ...
    expect: {
      reminderLabel: "Taylor turns 34 today",
      reminderRecipient: "Taylor",
      textActionTarget: "Taylor",
      ecardTarget: "Taylor",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Taylor turns 34 today",
      notificationBody,
    },
  },
  {
  ...
  },
  {
    ...
    expect: {
      reminderLabel: "Morgan turns 31 today",
      reminderRecipient: "Morgan",
      textActionTarget: "Morgan",
      ecardTarget: "Morgan",
      coffeeEligible: true,
      giftEligible: false,
      notificationTitle: "Morgan turns 31 today",
      notificationBody,
    },
  },
];
